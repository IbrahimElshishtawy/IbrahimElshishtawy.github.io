...
const PROJECTS_DATA = {
  ...
  bostan: {
    ...
    secondaryImages: [
      "assets/assets/bostan_settings.png",
      "assets/assets/بستان.jpg"
    ],
    demoLink: "#",
    repoLink: "https://github.com/IbrahimElshishtawy",
    accentColor: "#06b6d4",
  ...
  tolabapp: {
    ...
    screenshotLabels: [
      "Database Schema — tolab_university",
  ...
  eduassess: {
    ...
    image:        "assets/assets/Edu Assess.jpg",
    demoLink: "#",
    repoLink: "https://github.com/IbrahimElshishtawy",
    accentColor: "#8b5cf6",
    features: [
  ...
  quickbit: {
    ...
    image:        "assets/assets/Quick Bit.jpg",
    demoLink: "#",
    repoLink: "https://github.com/IbrahimElshishtawy",
    accentColor: "#06b6d4",
    features: [
  ...
  rm: {
    title:    "Aqar (عقار) — Extended",
    category: "REAL ESTATE · OFFLINE-FIRST",
    subtitle: "An enterprise-grade supply chain, resource planner, and operational workforce dispatcher dashboard. Extended view of the Aqar real estate platform.",
    tags:  ["Flutter", "Dart", "GetX", "Logistics Engine", "Task Manager"],
    image:        "assets/assets/Aqar.jpg",
    secondaryImage: "assets/assets/aqar_activities.png",
    demoLink: "#",
    repoLink: "https://github.com/IbrahimElshishtawy",
    accentColor: "#10b981",
  ...
  writle: {
    ...
    image:        "assets/assets/writle.jpg",
    demoLink: "#",
    repoLink: "https://github.com/IbrahimElshishtawy",
    accentColor: "#f59e0b",
    features: [
